namespace Nop.Plugin.Payments.AfterpayPayment
{
    public static class AfterpayPaymentDefaults
    {
        ...
        public static string PLUGIN_SYSTEM_NAME => "Payments.AfterpayPayment";
        ...
        public static string GET_REFUND => "/v2/payments/{0}/refund";
        ...
        public static string PAYMENT_STATUS_UPDATE_TASK_TYPE => "Nop.Plugin.Payments.AfterpayPayment.Areas.Admin.Extensions.UpdateAfterpayPaymentStatus, Nop.Plugin.Payments.AfterpayPayment";
    }
}
